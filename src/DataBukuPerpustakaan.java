...
public class DataBukuPerpustakaan {
    public static void main(String[] args) {
        ...
        Buku Buku1 = new Buku("Teknologi Informasi dan Komunikasi (TIK)","Deepublish","Hamdan Husein",542,2017,                                                                           "Buku ajar Teknologi, Informasi, dan Komunikasi (Prinsip dan Aplikasi dalam Studi Pemikiran Islam) ini membantu mahasiswa memahami sistem \ninformasi komputer, karenan saat ini kehidupan manusia tidak bisa lepas dari perkembangan komputer. ");
        ...
        Buku Buku3 = new Buku("Dasar Logika Pemrograman Komputer","Elex Media Komputindo","Abdul Kadir",331,2017,                                                                         "Buku ini dapat di gunakan oleh siapa saja yang bermaksud mendalami penyusunan algoritma untuk menyelesaikan masalah dengan komputer. Buku\nini menekan kan pada penyusunan logika yang berbasis diagram alir (flowchart), yang menjadi fondasi pada pembuatan program komputer.");
        ...
        Buku Buku7 = new Buku("Buku Filsafat Manusia Untuk Psikologi","Pt Remaja Rosdakarya","FATTAH HANURAWAN, PROF., DR.",144,2021,                                                     "Filsafat banyak memengaruhi psikologi, termasuk pemikiran mengenai hakikat manusia. Untuk memahami esensi yang kompleks dalam diri       \nmanusia kita butuh acuan yang teruji dan tepercaya");
        ...
        Buku Buku23 = new Buku("Psikologi Kesehatan – Konsep, Masalah, dan Pemikiran Untuk Indonesia","Penerbit Buku Kompas","Eunike Sri Tyas Suci",516,2022,                             "Buku Psikologi Kesehatan: Konsep, Masalah, dan Pemikiran untuk Indonesia membahas berbagai masalah kesehatan dari perspektif             \nbiopsikososiokultural. Diawali dengan pemahaman dasar psikologi kesehatan, buku ini melihat dimensi sosial kesehatan, masalah kesehatan sosial di Indonesia,\nserta beberapa pemikiran tentang psikologi kesehatan Indonesia di masa depan.");
        Buku Buku24 = new Buku("Psikologi Suatu Pengantar (Edisi Terbaru)","Andi Publisher","Drs. M Dimyati Mahmud",352,2018,                                                             "Buku ini berisikan bermacam telaah teoritis tentang gejala-gejala dan fungsi kejiwaan, peristiwa-peristiwa psikis terutama pada manusia, \nserta berbagai faktor yang mempengaruhinya. Selain hadir sebagai sumber pengajaran bagi mahasiswa bidang studi terkait, buku ini sekaligus hadir untuk      \nmenambah jumlah kepustakaan psikologi berbahasa Indonesia di tanah air. Buku ini terutama diperuntukkan bagi mahasiswa Fakultas Ilmu Pendidikan semua   \njurusan dan program studi yang menempuh mata kuliah Dasar-Dasar Psikologi sebagai bekal untuk mempelajari bidang-bidang psikologi yang lain, seperti psikologi \nperkembangan, psikologi pendidikan, psikologi abnormal dan psikologi kepribadian");
