...
public class DataBukuPerpustakaan {
    public static void main(String[] args) {
        ...
        Buku Buku1 = new Buku("Teknologi Informasi dan Komunikasi (TIK)","Deepublish","Hamdan Husein",542,2017,"Buku ajar Teknologi, Informasi, dan Komunikasi (Prinsip dan Aplikasi dalam Studi Pemikiran Islam) ini membantu mahasiswa \nmemahami sistem informasi komputer, karenan saat ini kehidupan manusia tidak bisa lepas dari perkembangan komputer. ");
        ...
        Buku Buku3 = new Buku("Dasar Logika Pemrograman Komputer","Elex Media Komputindo","Abdul Kadir",331,2017,"Buku ini dapat di gunakan oleh siapa saja yang bermaksud mendalami penyusunan algoritma untuk menyelesaikan masalah  \ndengan komputer. PraktikumPemrogramanLanjut.Buku ini menekan kan pada penyusunan logika yang berbasis diagram alir (flowchart), yang menjadi fondasi pada pembuatan program komputer.");
