...
import PraktikumPemrogramanLanjut.Buku;
...
public static void main(String[] args) {
        ...
        Buku Buku1 = new Buku("Teknologi Informasi dan Komunikasi (TIK)","Deepublish","Hamdan Husein",542,2017,                                                                           "PraktikumPemrogramanLanjut.Buku ajar Teknologi, Informasi, dan Komunikasi (Prinsip dan Aplikasi dalam Studi Pemikiran Islam) ini membantu mahasiswa memahami sistem \ninformasi komputer, karenan saat ini kehidupan manusia tidak bisa lepas dari perkembangan komputer. ");
        ...
        Buku Buku3 = new Buku("Dasar Logika Pemrograman Komputer","Elex Media Komputindo","Abdul Kadir",331,2017,                                                                         "PraktikumPemrogramanLanjut.Buku ini dapat di gunakan oleh siapa saja yang bermaksud mendalami penyusunan algoritma untuk menyelesaikan masalah dengan komputer. PraktikumPemrogramanLanjut.Buku\nini menekan kan pada penyusunan logika yang berbasis diagram alir (flowchart), yang menjadi fondasi pada pembuatan program komputer.");
        ...
        Buku Buku23 = new Buku("Psikologi Kesehatan – Konsep, Masalah, dan Pemikiran Untuk Indonesia","Penerbit PraktikumPemrogramanLanjut.Buku Kompas","Eunike Sri Tyas Suci",516,2022,                             "PraktikumPemrogramanLanjut.Buku Psikologi Kesehatan: Konsep, Masalah, dan Pemikiran untuk Indonesia membahas berbagai masalah kesehatan dari perspektif             \nbiopsikososiokultural. Diawali dengan pemahaman dasar psikologi kesehatan, buku ini melihat dimensi sosial kesehatan, masalah kesehatan sosial di Indonesia,\nserta beberapa pemikiran tentang psikologi kesehatan Indonesia di masa depan.");
        Buku Buku24 = new Buku("Psikologi Suatu Pengantar (Edisi Terbaru)","Andi Publisher","Drs. M Dimyati Mahmud",352,2018,                                                             "PraktikumPemrogramanLanjut.Buku ini berisikan bermacam telaah teoritis tentang gejala-gejala dan fungsi kejiwaan, peristiwa-peristiwa psikis terutama pada manusia, \nserta berbagai faktor yang mempengaruhinya. Selain hadir sebagai sumber pengajaran bagi mahasiswa bidang studi terkait, buku ini sekaligus hadir untuk      \nmenambah jumlah kepustakaan psikologi berbahasa Indonesia di tanah air. PraktikumPemrogramanLanjut.Buku ini terutama diperuntukkan bagi mahasiswa Fakultas Ilmu Pendidikan semua   \njurusan dan program studi yang menempuh mata kuliah Dasar-Dasar Psikologi sebagai bekal untuk mempelajari bidang-bidang psikologi yang lain, seperti psikologi \nperkembangan, psikologi pendidikan, psikologi abnormal dan psikologi kepribadian");
        ...
        Buku Buku29 = new Buku("Psikologi Politik","Pbk","WHINDA YUSTISIA, MOH. ABDUL HAKIM, RAHMAN ARDI",150,2021,                                                                       "PraktikumPemrogramanLanjut.Buku ini secara keseluruhan berisi tentang pandangan psikologi tentang masalah kebangsaan, mulai dari Pancasila, krisis kepemimpinan,    \nkonflik antarkelompok, rekonsiliasi, partisipasi politik, dan gerakan sosial.Kajian ini tidak hanya didesain bagi para penggelut diskursus psikologi, namun \n1juga bagi para pemerhati politik, akademisi cabang keilmuan lain, aktivis-aktivis gerakan sosial, dan juga khalayak umum yang mempunyai minat dan     \ntekadterhadap penyelesaian masalah kebangsaan dan kenegaraan.");
